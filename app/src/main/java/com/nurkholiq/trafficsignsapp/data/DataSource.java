...
import com.nurkholiq.trafficsignsapp.model.Question;
...
public class DataSource {
    ...
    public static List<Traffic> tambahanListTraffic() {
        ArrayList<Traffic> arr = new ArrayList<>();
        arr.add(new Traffic(R.drawable.group_10, "Wajib Ke Kiri", "Menandakan di depan akan ada tikungan atau belokan ke kiri arah jarum jam 10.30"));
        arr.add(new Traffic(R.drawable.group_22, "Wajib Ke Kanan", "Menandakan di depan akan ada tikungan atau belokan ke kanan arah jarum jam 13.30."));
        arr.add(new Traffic(R.drawable.group_21, "Tikungan tajam ke kiri", "Menandakan di depan akan ada tikungan atau belokan ke kanan arah jarum jam 13.300."));
    ...
    public static List<Traffic> nomoruteListTraffic() {
        ArrayList<Traffic> arr = new ArrayList<>();
        arr.add(new Traffic(R.drawable.group_10, "Wajib Ke Kiri", "Menandakan di depan akan ada tikungan atau belokan ke kiri arah jarum jam 10.30"));
        arr.add(new Traffic(R.drawable.group_22, "Wajib Ke Kanan", "Menandakan di depan akan ada tikungan atau belokan ke kanan arah jarum jam 13.30."));
        arr.add(new Traffic(R.drawable.group_21, "Tikungan tajam ke kiri", "Menandakan di depan akan ada tikungan atau belokan ke kanan arah jarum jam 13.300."));
    ...
    public static List<Question> getQuestions() {
        ...
        questions.add(new Question("Apakah arti dari simbol diatas?", "Berhenti", new ArrayList(Arrays.asList("Lanjut", "Berhenti", "Belok", "Putar balik")), R.drawable.group_2));
        questions.add(new Question("Simbol manakah yang digunakan sebagai tanda berhenti?", String.valueOf(R.drawable.group_2), new ArrayList(Arrays.asList(String.valueOf(R.drawable.group_1), String.valueOf(R.drawable.group_4), String.valueOf(R.drawable.group_10), String.valueOf(R.drawable.group_2))), -1));
        return questions;
    }
}
