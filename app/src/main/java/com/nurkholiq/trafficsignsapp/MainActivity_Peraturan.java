...
import com.nurkholiq.trafficsignsapp.databinding.ActivityMainPeraturanBinding;

public class MainActivity_Peraturan extends AppCompatActivity {

    private ActivityMainPeraturanBinding binding;
    private int collapse = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityMainPeraturanBinding.inflate(getLayoutInflater());
